...
def find_flat_base_patterns(df, order=3, rel_tol=1, min_pattern=10):
    ...
    for i in range(0, (len(temp_df) - 3)):
        ...
        and cal_pect_change(temp_df.iloc[i]["max_close"], temp_df.iloc[i+1]["max_close"]) < rel_tol:
            is_current_flat_base = True
            # print("##########################is_current_flat_base##############################")
            # print(cal_pect_change(temp_df.iloc[i]["max_close"], temp_df.iloc[i+1]["max_close"]))
        # min min
        elif temp_df.iloc[i]["min_close"] > 0 and temp_df.iloc[i+1]["min_close"] > 0 \
        and cal_pect_change(temp_df.iloc[i]["min_close"], temp_df.iloc[i+1]["min_close"]) < rel_tol:
            is_current_flat_base = True
            # print("##########################is_current_flat_base##############################")
            # print(cal_pect_change(temp_df.iloc[i]["min_close"], temp_df.iloc[i+1]["min_close"]))
        # max min max min
        ...
        and cal_pect_change(temp_df.iloc[i]["max_close"], temp_df.iloc[i+2]["max_close"]) < rel_tol \
        and cal_pect_change(temp_df.iloc[i+1]["min_close"], temp_df.iloc[i+3]["min_close"]) < rel_tol:
            is_current_flat_base = True
            # print("##########################is_current_flat_base##############################")
            # print(cal_pect_change(temp_df.iloc[i]["max_close"], temp_df.iloc[i+2]["max_close"]))
            # print(cal_pect_change(temp_df.iloc[i+1]["min_close"], temp_df.iloc[i+3]["min_close"]))
        # max min min max
        elif temp_df.iloc[i]["max_close"] > 0 and temp_df.iloc[i+1]["min_close"] > 0 \
        and temp_df.iloc[i+2]["min_close"] > 0 and temp_df.iloc[i+3]["max_close"] > 0 \
        and cal_pect_change(temp_df.iloc[i]["max_close"], temp_df.iloc[i+3]["max_close"]) < rel_tol \
        and cal_pect_change(temp_df.iloc[i+1]["min_close"], temp_df.iloc[i+2]["min_close"]) < rel_tol:
            is_current_flat_base = True
            # print("##########################is_current_flat_base##############################")
            # print(cal_pect_change(temp_df.iloc[i]["max_close"], temp_df.iloc[i+3]["max_close"]))
            # print(cal_pect_change(temp_df.iloc[i+1]["min_close"], temp_df.iloc[i+2]["min_close"]))
        # min max min max
        elif temp_df.iloc[i]["min_close"] > 0 and temp_df.iloc[i+1]["max_close"] > 0 \
        and temp_df.iloc[i+2]["min_close"] > 0 and temp_df.iloc[i+3]["max_close"] > 0 \
        and cal_pect_change(temp_df.iloc[i]["min_close"], temp_df.iloc[i+2]["min_close"]) < rel_tol \
        and cal_pect_change(temp_df.iloc[i+1]["max_close"], temp_df.iloc[i+3]["max_close"]) < rel_tol:
            is_current_flat_base = True
            # print("##########################is_current_flat_base##############################")
            # print(cal_pect_change(temp_df.iloc[i]["min_close"], temp_df.iloc[i+2]["min_close"]))
            # print(cal_pect_change(temp_df.iloc[i+1]["max_close"], temp_df.iloc[i+3]["max_close"]))
        # min max max min
        elif temp_df.iloc[i]["min_close"] > 0 and temp_df.iloc[i+1]["max_close"] > 0 \
        and temp_df.iloc[i+2]["max_close"] > 0 and temp_df.iloc[i+3]["min_close"] > 0 \
        and cal_pect_change(temp_df.iloc[i]["min_close"], temp_df.iloc[i+3]["min_close"]) < rel_tol \
        and cal_pect_change(temp_df.iloc[i+1]["max_close"], temp_df.iloc[i+2]["max_close"]) < rel_tol:
            is_current_flat_base = True
            # print("##########################is_current_flat_base##############################")
            # print(cal_pect_change(temp_df.iloc[i]["min_close"], temp_df.iloc[i+3]["min_close"]))
            # print(cal_pect_change(temp_df.iloc[i+1]["max_close"], temp_df.iloc[i+2]["max_close"]))
        else:
            is_current_flat_base = False          
